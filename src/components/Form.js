        ...
        <form onSubmit={handleSubmit(onSubmit)} autocomplete="on">
            <div className="px-4 py-4">
                ...
                <div className="w-full flex flex-wrap py-6 px-5">
                    <div className="grid grid-cols-2 gap-4 w-full max-sm:grid-cols-1 max-sm:gap-2">
                        <div className="w-full relative input_group">
                            <label htmlFor="name"
                                className="  text-base font-bold font-serif font-barlow 2xl:text-2xl">Name: <span className="material-symbols-outlined text-red-600 text-xs">
                                    emergency
                                </span>
                            </label>
                            <input
                    ...
                    <div className="w-full relative input_group max-sm:mt-4">
                        <label
